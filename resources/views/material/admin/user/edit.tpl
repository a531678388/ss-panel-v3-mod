							...
							<div class="card-inner">
								...
								<div class="form-group form-group-label">
									<label for="is_multi_user">
										<label class="floating-label" for="sort">公共端口承载</label>
										<select id="is_multi_user" class="form-control" name="is_multi_user">
											<option value="0" {if $edit_user->is_multi_user==0}selected{/if}>非公共端口承载</option>
											<option value="1" {if $edit_user->is_multi_user==1}selected{/if}>混淆式公共端口承载</option>
											<option value="2" {if $edit_user->is_multi_user==2}selected{/if}>协议式公共端口承载</option>
										</select>
									</label>
								</div>
