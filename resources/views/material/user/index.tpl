								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<div class="card-action">
											...
											{if URL::SSRCanConnect($user)}
											<p>SSR 个人端口订阅地址</p>
											<p><code>{$apiUrl}/link/{$ssr_sub_token}?mu=0</code></p><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ssr_sub_token}?mu=0">点击拷贝</button>
											<p><a href="Shadowrocket://add/sub://{$ssr_url_0}?remarks=Dler%20Cloud" target="_blank"><span class="icon">check</span>&nbsp;Shadwrocket：一键订阅</a></p>
											<p><a href="quantumult://configuration?server={$ssr_url_0}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅</a></p>
											{/if}
											<p>SSR 公共端口订阅地址</p>
											<p><code>{$apiUrl}/link/{$ssr_sub_token}?mu=1</code></p><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ssr_sub_token}?mu=1">点击拷贝</button>
										...
										<div class="card-action">
											...
											<p><code>{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=0&mitm=0</code></p><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=0&mitm=0">点击拷贝</button>
											<p><a href="surge:///install-config?url={$ss_url_0}" target="_blank"><span class="icon">check</span>&nbsp;Surge：一键托管</a></p>

											<p>Surge / Surfboard 个人端口托管地址（MitM）</p>
											<p><code>{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=0&mitm=1</code></p><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=0&mitm=1">点击拷贝</button>
											...
											<p><code>{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=1&mitm=0</code></p><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=1&mitm=0">点击拷贝</button>
											<p><a href="surge:///install-config?url={$ss_url_1}" target="_blank"><span class="icon">check</span>&nbsp;Surge：一键托管</a></p>
										</div>

										<p>Surge / Surfboard 公共端口托管地址（MitM）</p>
											<p><code>{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=1&mitm=1</code></p><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=1&mitm=1">点击拷贝</button>
