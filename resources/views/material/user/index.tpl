								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<div class="card-action">
											...
											<p><a href="Shadowrocket://add/sub://{$ssr_url_0}?remarks=Dler%20Cloud" target="_blank"><span class="icon">check</span>&nbsp;Shadwrocket：一键订阅 SSR 个人端口节点</a></p>
											<p><a href="quantumult://configuration?server={$ssr_url_0}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅所有节点</a></p>
											<br>
											{/if}
											<p>SSR 公共端口订阅地址</p>
											...
											<p><a href="Shadowrocket://add/sub://{$ssr_url_1}?remarks=Dler%20Cloud" target="_blank"><span class="icon">check</span>&nbsp;Shadwrocket：一键订阅所有节点</a></p>
											<p><a href="quantumult://configuration?server={$ssr_url_1}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅所有节点</a></p>
											<br>
											<br>
											...
											<p><a href="Shadowrocket://add/sub://{$v2_url}?remarks=Dler%20Cloud" target="_blank"><span class="icon">check</span>&nbsp;Shadwrocket：一键订阅所有 V2Ray 节点</a></p>
											<p><a href="quantumult://configuration?server={$v2_url_x}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅所有 V2Ray 节点</a></p>
										</div>
										...
										<div class="card-action">
											...
											<p><a href="surge:///install-config?url={$ss_url_0}" target="_blank"><span class="icon">check</span>&nbsp;Surge / Surfboard：一键托管所有节点</a></p>
											<br>
											{/if}
											...
											<p><a href="surge:///install-config?url={$ss_url_1}" target="_blank"><span class="icon">check</span>&nbsp;Surge / Surfboard：一键托管所有节点</a></p>
											<br>
											<br>
											{if URL::SSCanConnect($user)}
											...
											<p><a href="surge:///install-config?url={$ss_url_0_mitm}" target="_blank"><span class="icon">check</span>&nbsp;Surge：一键托管所有节点</a></p>
											<br>
											{/if}
											...
											<p><a href="surge:///install-config?url={$ss_url_1_mitm}" target="_blank"><span class="icon">check</span>&nbsp;Surge：一键托管所有节点</a></p>
											<br>
											<br>
											{if URL::SSCanConnect($user)}
											...
											<button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=0&mitm=1">点击拷贝</button>
											<p><a href="surge:///install-config?url={$ss_url_0_mitm_new}" target="_blank"><span class="icon">check</span>&nbsp;Surge：一键托管所有节点</a></p>
											<br>
											{/if}
											<p>Surge 3 公共端口托管地址（MitM）</p>
											<p><code>{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=1&mitm=1&new=1</code></p>
											<button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_ss=1&is_mu=1&mitm=1&new=1">点击拷贝</button>
											<p><a href="surge:///install-config?url={$ss_url_1_mitm_new}" target="_blank"><span class="icon">check</span>&nbsp;Surge：一键托管所有节点</a></p>
										</div>
