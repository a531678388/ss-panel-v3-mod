								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<div class="card-action">
											...
											<p><a href="quantumult://configuration?server={$quantumult_url_0}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅</a></p>
											{/if}
											<p>公共端口订阅地址</p>
											...
											<p><a href="Shadowrocket://add/sub://{$shadowrocket_url_1}?remarks=Dler%20Cloud" target="_blank"><span class="icon">check</span>&nbsp;Shadwrocket：一键订阅</a></p>
											<p><a href="quantumult://configuration?server={$quantumult_url_1}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅</a></p>
										</div>
