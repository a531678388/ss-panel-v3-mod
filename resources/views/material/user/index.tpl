						...
						<div class="mb-3">
							...
							<div class="nav-wrapper">
								<ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-text" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link mb-sm-3 mb-md-0" id="all_v2-tab" data-toggle="tab" href="#all_v2" role="tab" aria-controls="all_ss" aria-selected="false">V2Ray</a>
									</li>
								</ul>
							</div>
									...
									<div class="tab-content" id="myTabContent">
										...
										<div class="tab-pane fade" id="all_ssr" role="tabpanel" aria-labelledby="all_ssr-tab">
											<div style="padding:18px">
												{if URL::SSRCanConnect($user)}
													...
													<p><a href="Shadowrocket://add/sub://{$ssr_url_0}?remarks=Dler%20Cloud" target="_blank" class="btn btn-primary mt-4">&nbsp;Shadwrocket：一键导入订阅</a></p>
													<p><a href="quantumult://configuration?server={$ssr_url_0}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank" class="btn btn-primary mt-4">&nbsp;Quantumult：一键导入订阅&规则</a></p>
												{else}
													...
													<p>
													<a href="Shadowrocket://add/sub://{$ssr_url_1}?remarks=Dler%20Cloud" target="_blank" class="btn btn-primary mt-4">&nbsp;Shadwrocket：一键导入订阅</a>
													</p>
													<p>
													<a href="quantumult://configuration?server={$ssr_url_1}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank" class="btn btn-primary mt-4">&nbsp;Quantumult：一键导入订阅&规则</a>
													</p>
												{/if}
											</div>
										</div>
										<div class="tab-pane fade" id="all_ss" role="tabpanel" aria-labelledby="all_ss-tab">
											...
											{if URL::SSCanConnect($user)}
												...
												<p>
												<a href="surge:///install-config?url={$ss_url_0}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge / Surfboard：一键托管&规则</a>
												</p>
											{else}
												...
												<p>
												<a href="surge:///install-config?url={$ss_url_1}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge / Surfboard：一键托管&规则</a>
												</p>
											{/if}
											{if URL::SSCanConnect($user)}
												...
												<p>
												<a href="surge:///install-config?url={$ss_url_0_mitm}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge / Surfboard：一键托管&规则</a>
												</p>
											{else}
												...
												<p>
												<a href="surge:///install-config?url={$ss_url_1_mitm}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge / Surfboard：一键托管&规则</a>
												</p>
											{/if}
											{if URL::SSCanConnect($user)}
												...
												<p>
												<a href="surge3:///install-config?url={$ss_url_0_mitm_new}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge / Surfboard：一键托管&规则</a>
												</p>
											{else}
												...
												<p>
												<a href="surge3:///install-config?url={$ss_url_1_mitm_new}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge / Surfboard：一键托管&规则</a>
												</p>
											{/if}
