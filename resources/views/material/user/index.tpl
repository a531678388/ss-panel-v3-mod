								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<div class="card-action">
											...
											<p><a href="quantumult://configuration?server={$v2_url_x}&filter={$filterUrl}&rejection={$rejectUrl}" target="_blank"><span class="icon">check</span>&nbsp;Quantumult：一键订阅&规则</a></p>
										</div>
