              ...
              <div class="card-header bg-white pb-5">
                ...
                <div class="btn-wrapper text-center">
                  <a  class="btn btn-neutral btn-icon">
                    ...
                    <span class="btn-inner--text" data-toggle="modal" data-target="#tg_login">Telegram 快捷登陆</span>
                  </a>
                </div>
              </div>
                ...
                <form action="javascript:void(0);" method="POST">
                  ...
                  <div class="form-group">
                    <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Google Authenticator" type="code" id="code">
                    </div>
                  </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.ret > 0) {
                            ...
                            if (data.ret == -1) {
                                jQuery('#telegram-qr').replaceWith('此二维码已过期，请刷新页面后重试。');
                                jQuery('#code_number').replaceWith('此验证码已过期，请刷新页面后重试。');
                            }
                        }
                    },
                    error: function (jqXHR) {
